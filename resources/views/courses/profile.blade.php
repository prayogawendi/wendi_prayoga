                ...
                <tbody>
                    <tr>
                        <td colspan="2" class="td-img p-5 col-xxl-3 col-xl-3 col-lg-4 col-md-8 col-sm-10 col-12 bg-light shadow">
                            <form action="/profile/{{ $user[0]->username ?? "" }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                ...
                                @if ($user[0]->profile_wallpaper ?? "")
                                    <div style="width: 300px; height: 300px;" class="my-4">
                                        <div style="position: relative; padding-bottom: 100%;">
                                            <img src="/storage/{{ $user[0]->profile_wallpaper ?? "" }}" alt="" class="img-preview" style="width: 100%; height: 100%; position: absolute;">
                                        </div>
                                    </div>
                                @else
                                    <div style="width: 300px; height: 300px;" class="my-4">
                                        <div style="position: relative; padding-bottom: 100%;">
                                            <img src="/storage/profile_wallpaper/Default_Profile_Wallpaper.png" alt="" class="img-preview" style="width: 100%; height: 100%; position: absolute;">
                                        </div>
                                    </div>
                                @endif
